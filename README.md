...
台灣公務人員薪資靜態試算工具，支援首頁導覽、多職系、多加給表、升等比較、年度試算、多年收入預測與暗黑模式。
...
- 資料查詢提供下拉選單與橫向快速切換，方便在多張資料表間來回比對。
...
- 工程人員另增支 3,000 元
- 主管職務加給（依職等自動判斷，也可手動輸入金額）
- 健保眷口數：0–6 口
- 退撫基金制／個人專戶制（112年7月1日後初任，個人月提繳額依本俸 × 2 × 15% × 35% 試算）
- 考績等次：甲等、乙等、丙等
- 年終獎金月數（可調整）
- 每年薪資調整率（多年預測用）

預設試算情境為土木初任公務員：薦任第六職等本俸一級、專業加給表七、工程人員另增支、健保本人、個人專戶制。
...
| 退休撫卹基金舊制費率表、個人專戶制退撫法 | 全國法規資料庫／考試院主管法規系統 |
| 公教人員保險費率表 | 臺灣銀行公教保險部 |
